...
public class NetworkObjectPool : NetworkBehaviour
{
    ...
    private readonly Dictionary<GameObject, ObjectPool<NetworkObject>> m_PooledObjects = new();
    private readonly Dictionary<GameObject, int> m_NonPooledObjects = new();
    ...
    public int GetCurrentPrefabCount(GameObject prefab) => m_NonPooledObjects[prefab];
